...
export const CloudIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M17.5 19c0-1.7-1.3-3-3-3h-11a4 4 0 1 1 .9-7.9 4 4 0 0 1 7.4-1.3 4 4 0 0 1 5.7 5.6v.6c0 3.3-2.7 6-6 6Z" />
  </svg>
);
...
export const CrossIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 14V8" />
    <path d="M8 12h8" />
  </svg>
);
